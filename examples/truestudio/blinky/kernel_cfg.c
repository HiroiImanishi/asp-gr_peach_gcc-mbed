...
static STK_T _kernel_stack_BLINKY_MAIN_TASK[COUNT_STK_T(BLINKY_MAIN_TASK_STACK_SIZE)];
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (intptr_t)(0), (TASK)(init_main_task), INT_PRIORITY(INIT_MAIN_TASK_PRI), ROUND_STK_T(INIT_MAIN_TASK_STACK_SIZE), _kernel_stack_INIT_MAIN_TASK },
	{ (TA_ACT), (intptr_t)(0), (TASK)(blinky_main_task), INT_PRIORITY(BLINKY_MAIN_TASK_PRI), ROUND_STK_T(BLINKY_MAIN_TASK_STACK_SIZE), _kernel_stack_BLINKY_MAIN_TASK }
};

TCB _kernel_tcb_table[TNUM_TSKID];

const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_LogTask_Task, INIT_MAIN_TASK, BLINKY_MAIN_TASK
};
